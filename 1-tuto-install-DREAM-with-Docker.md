...
* 1.2 Download the model code from GitHub (follow instructions in option 1 OR option 2):
  ...
  <details>
  <summary>Option A: Download from the terminal with `git clone` _[click here to follow instructions)]_</summary>
  ...
  <details>
  <summary>Option B: Download by clicking on the GitHub webpage _[(click here to follow instructions)]_</summary>
